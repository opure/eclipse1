...
public class ArticleBizImpl extends BasicBizImpl implements IArticleBiz {
	...
	public List<ArticleEntity> queryList(PageUtil page, String orderBy, boolean order, String keyword, String articleType, int basicCategoryId, int webId) {
		return articleDao.queryList(webId, categoryBiz.queryChildrenCategoryIds(basicCategoryId), null, null, page.getPageNo() * page.getPageSize(), page.getPageSize(), orderBy, order);
	}
	...
	public List<ArticleEntity> queryList(int webId, List<Integer> basicCategoryIds, String flag, String noFlag, int begin, int count, String orderBy, boolean order) {
		...
		List<ArticleEntity> articleList = articleDao.queryList(webId, basicCategoryIds.size() > 0 ? basicCategoryIds : null, flag, noFlag, begin, count, orderBy, order);
		return articleList;
	}
	...
	public List<ArticleEntity> queryListForSearch(ContentModelEntity conntentModel, Map whereMap, PageUtil page, int websiteId,List ids,Map orders) {
		...
		// 查找所有符合条件的文章实体
		articleList = articleDao.queryListForSearch(tableName, whereMap, start, end, websiteId,ids,orders);
	...
	@Override
	public List<BaseEntity> queryPageByCategoryId(int categoryId, PageUtil page, boolean _isHasChilds) {
		// TODO Auto-generated method stub
		// return articleDao.queryByView(categoryId, page);
		List list = categoryBiz.queryChildrenCategory(categoryId);
		// 分类不存在直接返回
	...
	@Override
	public int count(int webId, int basicCategoryId, String flag, String noFlag) {
		return articleDao.count(webId, basicCategoryId, flag, noFlag);
	}
	...
	@Override
	public ArticleEntity getNext(int appId, int basicId) {
		// TODO Auto-generated method stub
		return articleDao.getNextOrPrevious(appId, basicId, true);
	}

	@Override
	public ArticleEntity getPrevious(int appId, int basicId) {
		// TODO Auto-generated method stub
		return articleDao.getNextOrPrevious(appId, basicId, false);
	}
