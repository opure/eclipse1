...
public interface IArticleDao extends IBaseDao {
	 ...
	 * @return
	 */
	int count(@Param("webId")int webId, @Param("basicCategoryId") int basicCategoryId, @Param("flag")String flag, @Param("noFlag")String noFlag);
	...
	public List<ArticleEntity> queryListForSearch(@Param("tableName") String tableName, @Param("map") Map<String, List> map,
			@Param("pageNo") int pageNo, @Param("pageSize") int pageSize, @Param("websiteId") int websiteId,@Param("ids") List ids,@Param("sortMap") Map sortMap);
	 ...
	 * @param appId　应用编号
	 * @param basicId　文章编号
	 * @param flag　true:上一条 false:吓一条
	 * @return
	 */
	public ArticleEntity getNextOrPrevious(int appId, int basicId, boolean flag);
