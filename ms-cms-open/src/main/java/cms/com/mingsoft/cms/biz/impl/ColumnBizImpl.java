...
public class ColumnBizImpl extends CategoryBizImpl implements IColumnBiz {
	...
	public List<ColumnEntity> queryTopSiblingListByColumnId(int columnId){
		...
		if(columnEntity != null){
				list = columnDao.queryColumnByCategoryIdAndWebsiteIdAndModelId(0,columnEntity.getColumnWebsiteId(),null);
		}
		return list;
	}
	 ...
	 * @return 子栏目ID集合
	 */
	public List<Integer> queryChildIdsByColumnId(int categoryId){
		List<Integer> list = new ArrayList<Integer>();
		list = columnDao.queryColumnChildIdList(categoryId);
		return list;
	}
