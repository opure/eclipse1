...
public class ArticleEntity extends BasicEntity{
	...
	public String getArticleUrl(AppEntity app) {
		if (!StringUtil.isBlank(app.getAppMobileStyle())) {
			return app.getAppHostUrl()+RegexConstant.HTML_SAVE_PATH+File.separator+"m"+File.separator+this.getArticleUrl();
		}
		return app.getAppHostUrl()+File.separator+RegexConstant.HTML_SAVE_PATH+File.separator+this.getArticleUrl();
	}
}
