			...
			<table class="table table-bordered">
				<thead>
			        ...
			        <tr>
			            ...
			            <th class="col-md-3 text-center">标题</th>
			            <th class="col-md-2 text-center">模板</th>
			            <th class="col-md-4 text-center">域名</th>
		        ...
		        <tbody>
		        	...
		        	<tr> 
			           	<td class="text-center basicId">${listApp.appId?c?default(0)}</td>
			            <td class="text-left" id="name">${listApp.appName?default(0)}</td>
			            <td class="text-left">${listApp.appStyle?default("暂无模板")}</td>
			            <td class="text-left">${listApp.appUrl?default(0)}</td>
			            <td class="text-center">
	                    	...
	                    	<#else>
                    		<input type="hidden" class="managerId" name="managerId"  value="${listApp.appManagerId?c?default(0)}"/>
                    		<a class="btn btn-xs red tooltips updateModalBtn" data-toggle="tooltip" data-original-title="编辑管理员" data-id="">
                     			<i class="glyphicon glyphicon-user"></i>
                    		</a>
	                    	</#if>
	                    	<#if managerSession?has_content && managerSession.managerRoleID ==1>
	                    	<a class="btn btn-xs red tooltips del-btn " data-toggle="tooltip" data-original-title="删除站点" data-id="${listApp.appId?c?default(0)}">
		           	...
		           	<td colspan="6" class="text-center">
		            	<p class="alert alert-info" role="alert" style="margin:0">
		            		...
		            		<a href="${base}/manager/app/add.do" class="alert-link">
		            		您还没有添加站点，点击添加站点
		            		</a>
					  	</p>
					</td>
